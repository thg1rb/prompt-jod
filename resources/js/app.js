...
import { walletCategories } from './components/wallet-categories';
import { walletShow } from './components/wallet-show';
import { walletShare } from './components/wallet-share';
...
Alpine.data('walletCategories', walletCategories);
Alpine.data('walletShow', walletShow);
Alpine.data('walletShare', walletShare);
